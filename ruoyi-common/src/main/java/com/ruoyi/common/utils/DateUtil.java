...
public class DateUtil {
  ...
  public static ThreadLocal<SimpleDateFormat> dateFormatThreadLocal
          = ThreadLocal.withInitial(() -> new SimpleDateFormat(DateUtil.FORMAT_DATETIME));

  public static Date timestampToData(Long timestamp) {
    Date resultDate = null;
    String date = dateFormatThreadLocal.get().format(timestamp);
    try {
      resultDate = dateFormatThreadLocal.get().parse(date);
