/*
 ...
 Source Server         : myselfAliBaba
 Source Server Type    : MySQL
 Source Server Version : 50651
 Source Host           : 47.242.214.81:3306
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RuoyiScheduler', 'fenggenyuandeMacBook-Pro.local1620791431345', 1620791804830, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1620791440000, -1, 5, 'PAUSED', 'CRON', 1620791432000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1620791445000, -1, 5, 'PAUSED', 'CRON', 1620791434000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1620791440000, -1, 5, 'PAUSED', 'CRON', 1620791436000, 0, NULL, 2, '');
COMMIT;
...
CREATE TABLE `gen_table` (
  ...
  `tpl_category` varchar(200) COLLATE utf8_bin DEFAULT 'crud' COMMENT '使用的模板（crud单表操作 tree树表操作 sub主子表操作）',
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='代码生成业务表字段';
...
CREATE TABLE `member` (
  ...
  `name` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '会员姓名',
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='系统访问记录';
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2001 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='菜单权限表';
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=127 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='操作日志记录';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2021-05-12 11:50:56', '2021-05-11 00:58:50', 'admin', '2021-05-11 00:58:50', '', '2021-05-12 03:50:56', '管理员');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user_online` VALUES ('6eeed229-84fe-4320-95fc-401e226b2822', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome 9', 'Mac OS X', 'on_line', '2021-05-12 11:23:24', '2021-05-12 11:50:56', 1800000);
COMMIT;
